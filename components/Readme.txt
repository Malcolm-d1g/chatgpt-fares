...
To begin with, Message.js is used to render the main chat box container and the side menu; The side menu contains
 a button that allows the user to clear the chat history.
